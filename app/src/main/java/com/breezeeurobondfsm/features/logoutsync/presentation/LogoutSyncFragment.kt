package com.breezeeurobondfsm.features.logoutsync.presentation
...
import com.breezeeurobondfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezeeurobondfsm.features.billing.api.AddBillingRepoProvider
import com.breezeeurobondfsm.features.billing.model.AddBillingInputParamsModel
...
import com.breezeeurobondfsm.features.dashboard.presentation.ReasonDialog
...
import com.breezeeurobondfsm.features.document.model.AddEditDocumentInputParams
import com.breezeeurobondfsm.features.document.model.DocumentAttachmentModel
...
import com.breezeeurobondfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezeeurobondfsm.features.orderhistory.model.*
...
import com.breezeeurobondfsm.features.quotation.model.AddQuotInputModel
...
import com.breezeeurobondfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezeeurobondfsm.features.stock.api.StockRepositoryProvider
import com.breezeeurobondfsm.features.stock.model.AddStockInputParamsModel
import com.breezeeurobondfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.breezeeurobondfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezeeurobondfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezeeurobondfsm.features.timesheet.model.AddTimeSheetInputModel
import com.breezeeurobondfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezeeurobondfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezeeurobondfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.breezeeurobondfsm.mappackage.SendBrod
import com.breezeeurobondfsm.widgets.AppCustomTextView
import com.breezeeurobondfsm.MonitorService
import com.breezeeurobondfsm.MySingleton
import com.breezeeurobondfsm.app.AlarmReceiver
...
import com.breezeeurobondfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.breezeeurobondfsm.features.login.model.GetConcurrentUserResponse
...
import com.breezeeurobondfsm.features.orderITC.SyncDeleteOpptL
import com.breezeeurobondfsm.features.orderITC.SyncEditOppt
import com.breezeeurobondfsm.features.orderITC.SyncOppt
import com.breezeeurobondfsm.features.orderITC.SyncOpptProductL
import com.breezeeurobondfsm.features.orderITC.SyncOrd
import com.breezeeurobondfsm.features.orderITC.SyncOrdProductL
...
import com.breezeeurobondfsm.features.returnsOrder.ReturnProductList
import com.breezeeurobondfsm.features.returnsOrder.ReturnRequest
import com.breezeeurobondfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeeurobondfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeeurobondfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeeurobondfsmlogsample/log.zip").path);
