...
import com.breezeeurobondfsm.*
import com.breezeeurobondfsm.R
import com.breezeeurobondfsm.app.*
import com.breezeeurobondfsm.app.NewFileUtils.browseDocuments
import com.breezeeurobondfsm.app.NewFileUtils.browsePDFDocuments
import com.breezeeurobondfsm.app.NewFileUtils.getExtension
import com.breezeeurobondfsm.app.domain.*
import com.breezeeurobondfsm.app.types.DashboardType
...
import com.breezeeurobondfsm.app.utils.*
import com.breezeeurobondfsm.app.utils.AppUtils.Companion.isProfile
...
import com.breezeeurobondfsm.features.NewQuotation.*
import com.breezeeurobondfsm.features.NewQuotation.api.GetQuotRegProvider
import com.breezeeurobondfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezeeurobondfsm.features.SearchLocation.SearchLocationFragment
import com.breezeeurobondfsm.features.SearchLocation.locationInfoModel
import com.breezeeurobondfsm.features.TA.ViewAllTAListFragment
import com.breezeeurobondfsm.features.achievement.AchievementFragment
import com.breezeeurobondfsm.features.activities.presentation.*
import com.breezeeurobondfsm.features.addAttendence.*
import com.breezeeurobondfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezeeurobondfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezeeurobondfsm.features.addAttendence.model.GetReportToFCMResponse
import com.breezeeurobondfsm.features.addAttendence.model.GetReportToResponse
import com.breezeeurobondfsm.features.addAttendence.model.Leave_list_Response
import com.breezeeurobondfsm.features.addorder.presentation.AddOrderFragment
...
import com.breezeeurobondfsm.features.addshop.presentation.AddShopFragment
import com.breezeeurobondfsm.features.addshop.presentation.OTPVerificationDialog
import com.breezeeurobondfsm.features.addshop.presentation.ScanImageFragment
import com.breezeeurobondfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.breezeeurobondfsm.features.alarm.model.AlarmData
import com.breezeeurobondfsm.features.alarm.presetation.AttendanceReportFragment
import com.breezeeurobondfsm.features.alarm.presetation.PerformanceReportFragment
import com.breezeeurobondfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.breezeeurobondfsm.features.alarm.presetation.VisitReportFragment
import com.breezeeurobondfsm.features.attendance.AttendanceFragment
import com.breezeeurobondfsm.features.attendance.api.AttendanceRepositoryProvider
import com.breezeeurobondfsm.features.attendance.model.AttendanceRequest
import com.breezeeurobondfsm.features.attendance.model.AttendanceResponse
import com.breezeeurobondfsm.features.averageshop.presentation.AverageShopFragment
import com.breezeeurobondfsm.features.avgorder.presentation.AverageOrderFragment
import com.breezeeurobondfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezeeurobondfsm.features.beatCustom.TeamBeatListFragment
import com.breezeeurobondfsm.features.billing.presentation.AddBillingFragment
import com.breezeeurobondfsm.features.billing.presentation.BillingDetailsFragment
import com.breezeeurobondfsm.features.billing.presentation.BillingListFragment
import com.breezeeurobondfsm.features.changepassword.presentation.ChangePasswordDialog
import com.breezeeurobondfsm.features.chat.model.ChatListDataModel
import com.breezeeurobondfsm.features.chat.model.ChatUserDataModel
import com.breezeeurobondfsm.features.chat.model.GroupUserDataModel
import com.breezeeurobondfsm.features.chat.presentation.*
import com.breezeeurobondfsm.features.chatbot.presentation.ChatBotFragment
import com.breezeeurobondfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.breezeeurobondfsm.features.chatbot.presentation.ReportsFragment
import com.breezeeurobondfsm.features.chatbot.presentation.SelectLanguageDialog
import com.breezeeurobondfsm.features.commondialog.presentation.CommonDialog
import com.breezeeurobondfsm.features.commondialog.presentation.CommonDialogClickListener
import com.breezeeurobondfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.breezeeurobondfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezeeurobondfsm.features.contacts.ActivityDtlsFrag
import com.breezeeurobondfsm.features.contacts.AddOpptFrag
import com.breezeeurobondfsm.features.contacts.ContactDtls
import com.breezeeurobondfsm.features.contacts.ContactGr
import com.breezeeurobondfsm.features.contacts.ContactsAddFrag
import com.breezeeurobondfsm.features.contacts.ContactsFrag
import com.breezeeurobondfsm.features.contacts.SchedulerAddFormFrag
import com.breezeeurobondfsm.features.contacts.SchedulerViewFrag
import com.breezeeurobondfsm.features.contacts.TemplateAddFrag
import com.breezeeurobondfsm.features.contacts.TemplateViewFrag
import com.breezeeurobondfsm.features.contacts.ViewCrmOpptFrag
import com.breezeeurobondfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.breezeeurobondfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezeeurobondfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezeeurobondfsm.features.damageProduct.ShopDamageProductListFrag
import com.breezeeurobondfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezeeurobondfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezeeurobondfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezeeurobondfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezeeurobondfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezeeurobondfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezeeurobondfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezeeurobondfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.breezeeurobondfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezeeurobondfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezeeurobondfsm.features.device_info.presentation.DeviceInfoListFragment
import com.breezeeurobondfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezeeurobondfsm.features.document.DocumentRepoFeatureNewFragment
import com.breezeeurobondfsm.features.document.presentation.DocumentListFragment
import com.breezeeurobondfsm.features.document.presentation.DocumentTypeListFragment
import com.breezeeurobondfsm.features.document.presentation.OpenFileWebViewFragment
import com.breezeeurobondfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.breezeeurobondfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezeeurobondfsm.features.dymanicSection.presentation.DynamicListFragment
import com.breezeeurobondfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.breezeeurobondfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezeeurobondfsm.features.home.presentation.HomeFragment
import com.breezeeurobondfsm.features.homelocation.presentation.HomeLocationFragment
import com.breezeeurobondfsm.features.homelocation.presentation.HomeLocationMapFragment
...
import com.breezeeurobondfsm.features.localshops.LocalShopListMapFragment
import com.breezeeurobondfsm.features.localshops.NearByShopsMapFragment
import com.breezeeurobondfsm.features.location.*
import com.breezeeurobondfsm.features.location.api.LocationRepoProvider
import com.breezeeurobondfsm.features.location.model.*
import com.breezeeurobondfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezeeurobondfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezeeurobondfsm.features.login.ShopFeedbackEntity
import com.breezeeurobondfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.breezeeurobondfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.breezeeurobondfsm.features.marketAssist.MarketAssistTabFrag
import com.breezeeurobondfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezeeurobondfsm.features.marketAssist.ShopListMarketAssistFrag
import com.breezeeurobondfsm.features.marketing.presentation.MarketingPagerFragment
import com.breezeeurobondfsm.features.meetinglist.prsentation.MeetingListFragment
import com.breezeeurobondfsm.features.member.MapViewForTeamFrag
import com.breezeeurobondfsm.features.member.model.TeamLocDataModel
import com.breezeeurobondfsm.features.member.model.TeamShopListDataModel
import com.breezeeurobondfsm.features.member.presentation.*
import com.breezeeurobondfsm.features.menuBeat.MenuBeatFrag
import com.breezeeurobondfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezeeurobondfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.breezeeurobondfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezeeurobondfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.breezeeurobondfsm.features.myjobs.model.CustomerDataModel
import com.breezeeurobondfsm.features.myjobs.presentation.*
import com.breezeeurobondfsm.features.mylearning.MyLearningFragment
import com.breezeeurobondfsm.features.myorder.presentation.MyOrderListFragment
import com.breezeeurobondfsm.features.myprofile.presentation.MyProfileFragment
...
import com.breezeeurobondfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezeeurobondfsm.features.nearbyshops.presentation.BeatListFragment
import com.breezeeurobondfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezeeurobondfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezeeurobondfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezeeurobondfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezeeurobondfsm.features.newcollection.CollectionDetailsStatusFragment
import com.breezeeurobondfsm.features.newcollection.CollectionShopListFragment
import com.breezeeurobondfsm.features.newcollection.NewCollectionListFragment
import com.breezeeurobondfsm.features.newcollectionreport.*
import com.breezeeurobondfsm.features.notification.NotificationFragment
import com.breezeeurobondfsm.features.orderITC.CartListFrag
import com.breezeeurobondfsm.features.orderITC.OrderListFrag
import com.breezeeurobondfsm.features.orderITC.ProductListFrag
import com.breezeeurobondfsm.features.orderITC.ViewNewOrdHisAllFrag
import com.breezeeurobondfsm.features.orderITC.ViewNewOrdHistoryFrag
import com.breezeeurobondfsm.features.orderITC.ViewOrdDtls
import com.breezeeurobondfsm.features.orderList.NewDateWiseOrderListFragment
import com.breezeeurobondfsm.features.orderList.NewOrderListFragment
import com.breezeeurobondfsm.features.orderList.OrderListFragment
import com.breezeeurobondfsm.features.orderdetail.presentation.OrderDetailFragment
import com.breezeeurobondfsm.features.orderhistory.ActivityMapFragment
import com.breezeeurobondfsm.features.orderhistory.OrderhistoryFragment
import com.breezeeurobondfsm.features.orderhistory.TimeLineFragment
import com.breezeeurobondfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezeeurobondfsm.features.orderhistory.model.FetchLocationRequest
import com.breezeeurobondfsm.features.orderhistory.model.FetchLocationResponse
import com.breezeeurobondfsm.features.orderhistory.model.LocationData
import com.breezeeurobondfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.breezeeurobondfsm.features.performance.GpsStatusFragment
import com.breezeeurobondfsm.features.performance.PerformanceFragment
import com.breezeeurobondfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezeeurobondfsm.features.performance.model.UpdateGpsInputParamsModel
import com.breezeeurobondfsm.features.performanceAPP.OwnPerformanceFragment
import com.breezeeurobondfsm.features.performanceAPP.PerformanceAppFragment
import com.breezeeurobondfsm.features.performanceAPP.allPerformanceFrag
import com.breezeeurobondfsm.features.permissionList.ViewPermissionFragment
import com.breezeeurobondfsm.features.photoReg.*
import com.breezeeurobondfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezeeurobondfsm.features.quotation.presentation.*
import com.breezeeurobondfsm.features.reimbursement.presentation.*
import com.breezeeurobondfsm.features.report.presentation.*
import com.breezeeurobondfsm.features.returnsOrder.*
import com.breezeeurobondfsm.features.settings.presentation.SettingsFragment
import com.breezeeurobondfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezeeurobondfsm.features.shopdetail.presentation.*
import com.breezeeurobondfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeeurobondfsm.features.stock.StockDetailsFragment
import com.breezeeurobondfsm.features.stock.StockListFragment
import com.breezeeurobondfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.breezeeurobondfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezeeurobondfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezeeurobondfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezeeurobondfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezeeurobondfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.breezeeurobondfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezeeurobondfsm.features.survey.SurveyFrag
import com.breezeeurobondfsm.features.survey.SurveyViewDtlsFrag
import com.breezeeurobondfsm.features.survey.SurveyViewFrag
import com.breezeeurobondfsm.features.task.presentation.AddTaskFragment
import com.breezeeurobondfsm.features.task.presentation.CalenderTaskFragment
import com.breezeeurobondfsm.features.task.presentation.EditTaskFragment
import com.breezeeurobondfsm.features.task.presentation.TaskListFragment
import com.breezeeurobondfsm.features.taskManagement.TaskManagementFrag
import com.breezeeurobondfsm.features.taskManagement.ViewTaskManagementFrag
import com.breezeeurobondfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.breezeeurobondfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.breezeeurobondfsm.features.timesheet.presentation.TimeSheetListFragment
import com.breezeeurobondfsm.features.viewAllOrder.CartFragment
import com.breezeeurobondfsm.features.viewAllOrder.OrderTypeListFragment
import com.breezeeurobondfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.breezeeurobondfsm.features.viewAllOrder.ViewCartFragment
import com.breezeeurobondfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezeeurobondfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezeeurobondfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezeeurobondfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezeeurobondfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezeeurobondfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezeeurobondfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.breezeeurobondfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.breezeeurobondfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezeeurobondfsm.features.viewPPDDStock.ViewStockFragment
import com.breezeeurobondfsm.features.weather.presentation.WeatherFragment
import com.breezeeurobondfsm.mappackage.MapActivity
import com.breezeeurobondfsm.mappackage.MapActivityWithoutPath
import com.breezeeurobondfsm.mappackage.SendBrod
...
import com.breezeeurobondfsm.features.login.api.opportunity.OpportunityRepoProvider
import com.breezeeurobondfsm.features.mylearning.KnowledgeHubAllVideoList
import com.breezeeurobondfsm.features.mylearning.LeaderboardLmsFrag
import com.breezeeurobondfsm.features.mylearning.LmsQuestionAnswerSet
import com.breezeeurobondfsm.features.mylearning.MyLearningAllVideoList
import com.breezeeurobondfsm.features.mylearning.MyLearningTopicList
import com.breezeeurobondfsm.features.mylearning.MyLearningVideoPlay
import com.breezeeurobondfsm.features.mylearning.MyPerformanceFrag
import com.breezeeurobondfsm.features.mylearning.NotificationLMSFragment
import com.breezeeurobondfsm.features.mylearning.SearchLmsFrag
import com.breezeeurobondfsm.features.mylearning.SearchLmsKnowledgeFrag
import com.breezeeurobondfsm.features.mylearning.SearchLmsLearningFrag
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezeeurobondfsmlogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeeurobondfsmlogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezeeurobondfsm/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezeeurobondfsmlogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezeeurobondfsmlogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezeeurobondfsmlogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
