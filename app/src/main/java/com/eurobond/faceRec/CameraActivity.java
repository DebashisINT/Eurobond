...
import com.eurobond.faceRec.env.ImageUtils;
  ...
  private void requestPermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
        Toast.makeText(
                CameraActivity.this,
                "Camera permission is required for this eurobond",
                Toast.LENGTH_LONG)
            .show();
      }
      if (shouldShowRequestPermissionRationale(PERMISSION_EXTERNAL)) {
        Toast.makeText(
                CameraActivity.this,
                "Read permission is required for this eurobond",
                Toast.LENGTH_LONG)
                .show();
      }
