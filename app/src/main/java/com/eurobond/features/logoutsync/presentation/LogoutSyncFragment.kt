package com.eurobond.features.logoutsync.presentation
...
import com.eurobond.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.eurobond.features.billing.api.AddBillingRepoProvider
import com.eurobond.features.billing.model.AddBillingInputParamsModel
...
import com.eurobond.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.eurobond.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.eurobond.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.eurobond.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.eurobond.features.orderhistory.model.*
...
import com.eurobond.features.quotation.model.AddQuotInputModel
...
import com.eurobond.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.eurobond.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.eurobond.features.timesheet.model.AddTimeSheetInputModel
...
import com.eurobond.features.login.model.WhatsappApiData
import com.eurobond.features.performance.model.Gps_status_list
import com.eurobond.features.performance.model.UpdateGpsInputListParamsModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xeurobondlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xeurobondlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xeurobondlogsample/log.zip").path);
