package com.eurobond.features.stockCompetetorStock.adapter
...
import com.eurobond.app.domain.CurrentStockEntryModelEntity
import com.eurobond.features.stockAddCurrentStock.`interface`.ShowStockOnClick
